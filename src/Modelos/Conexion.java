...
public class Conexion {
     private static final String URL = "jdbc:mysql://localhost:3306/residencia"; // Cambia si tu puerto/base cambian
    private static final String USER = "root"; // Tu usuario
    private static final String PASSWORD = "heryodi123"; // Tu contraseña de base de datos
